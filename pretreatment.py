...
def cut_img(img, seq_info, frame_name, pid):
    ...
    if img.sum() <= 10000:                               ### valeur de base : 10000
...
def cut_pickle(seq_info, pid):
    ...
    for _frame_name in frame_list:
        ...
        if img is not None:
            ...
            imageio.imwrite(save_path+'image'+str(id_frame)+'.png' , img)
            #scisc.imsave(save_path, img)                                ### ne marche pas 
            count_frame += 1
